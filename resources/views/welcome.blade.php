...
<body>
    ...
    <nav class="p-3 flex bg-white justify-between items-center">
        <a href="/" class="flex gap-2 items-center flex-1" id="brand">
            <img class="object-cover max-w-12 max-h-12" src="{{ asset('/logo.svg') }}" alt="logo">
                    ...
                    <div class="w-full px-4 md:w-1/3 lg:w-1/2">
                        <div class="my-1 flex justify-center md:justify-end">
                            <p class="text-base text-gray-7">
                                ...
                                <a href="https://www.instagram.com/fafarabbani/" target="_blank" class="text-gray-1 hover:underline">
                                    1810128262209
                                </a>
                            </p>
                        </div>
